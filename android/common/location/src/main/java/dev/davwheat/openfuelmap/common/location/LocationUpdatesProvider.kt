...
constructor(@param:ApplicationContext private val context: Context) {
    ...
    /**
     * Stream of device location updates. The first emission is the last known position, which
     * arrives immediately; each emission after it corresponds to the device having moved at least
     * [minimumDistanceMeters] from the last reported position.
     *
    ...
    fun locationUpdates(
        ...
        fusedLocationUpdates(
            context = context,
            updateIntervalMillis = intervalMs,
            minUpdateDistanceMeters = minimumDistanceMeters,
        )
}
